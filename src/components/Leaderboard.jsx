...
const { FiTrophy, FiArrowLeft, FiUser, FiTarget, FiAward } = FiIcons;
            ...
            {state.leaderboard.map((player, index) => (
              ...
              >
                <div className="grid grid-cols-12 gap-4 items-center">
                  ...
                  {/* Stats */}
                  <div className="col-span-1 text-green-400 font-medium">{player.wins}</div>
                  <div className="col-span-1 text-red-400 font-medium">{player.losses}</div>
                  <div className="col-span-1 text-yellow-400 font-medium">{player.draws}</div>
                  <div className="col-span-1 text-gray-300 font-medium">{player.gamesPlayed}</div>
                </div>
              </motion.div>
            ))}
          </div>
